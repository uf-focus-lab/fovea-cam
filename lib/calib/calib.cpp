...
Vx(Px, Py) = 1.64127143 * Px
           + -0.02880365 * Py
           + 0.01224670 * Px * Py
           + -0.23854626

           + // {1.64127143, -0.02880365, 0.01224670, -0.23854626}

Vy(Px, Py) = 0.04854627 * Px
           + -1.62766630 * Py
           + -0.26033701 * Px * Py
           + 1.24720024

           + // {0.04854627, -1.62766630, -0.26033701, 1.24720024}
...
Py(Vx, Vy) = -0.04906417 * Vx
           ...
           + // {-0.04906417, -0.59860207, 0.05216969, 0.75147662}
...
Coeff calib::PtoV = {.X = {1.64127143, -0.02880365, 0.01224670, -0.23854626},
                     .Y = {0.04854627, -1.62766630, -0.26033701, 1.24720024}},
